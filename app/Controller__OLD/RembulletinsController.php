...
class RembulletinsController extends AppController{	
   ...
   var $uses = array('User','Agdossier','Paramclassification','Paramechelon','Paramnatcontrat','Agcontrat','Paramstructurecotsocial','Paramservice','Paramdirection','Parambanque','Parammodepaie','Paramfonction','Paramstatactivation','Paramtypemvt','Paramtypefonction','Rembulitem','Agindemnite','Paramindemnite','Agaffectmutation','Agavencement','Paramdirection','Paramfonction','Paramgrillesal','Paramindemitem','Paramtypesalaire','Afftraite','Affbonpharma','Paramtauxprimebilan','Affbontraite','Paramsalbasegrat','Parambanque','Signataire');
	...
	public function index() {
		...
		$datedebut = (isset($tmp[0]['Rembulletin']['date_debut']))?$tmp[0]['Rembulletin']['date_debut']:'2020-01-01'; //$tmp[0]['Rembulletin']['date_debut'];
		$datefin = (isset($tmp[0]['Rembulletin']['date_fin']))?$tmp[0]['Rembulletin']['date_fin']:'2020-01-31'; //$tmp[0]['Rembulletin']['date_fin'];
		                	...
		                	$agent = array('Rembulletin'=>array(
		                        ...
		                        foreach ($indemnites as $indemnite){
		                            ...
		                            if($code == 1)
		                            {
		                                ...
		                                $sal = $this->Paramsalbasegrat->find('all', array('conditions'=>array(
		                                	"Paramsalbasegrat.agdossier_id='$agdossier'"), 'recursive'=>0));

		                                $base = $sal[0]['Paramsalbasegrat']['salaire_base_grat'];
		                               ...
		                               /**************Allocation********************************/
		                                ...
		                                //$allocation = $fam[0]['Rembulitem']['montant'];
		                                 ...
		                                 $avoir2 = (isset($mouton[0]['Rembulitem']['montant']))?$mouton[0]['Rembulitem']['montant']:0;
		                                  ...
		                                  /**************Avantage nature transport *******************/
		                             	$avantage = $this->Rembulitem->find('all', array('conditions'=>array(
		                                	"Rembulitem.rembulletin_id='$bulID'","Rembulitem.code='33'"), 'recursive'=>0));
		                                $avnatrans = (isset($avantage[0]['Rembulitem']['montant']))?$avantage[0]['Rembulitem']['montant']:0;//$retpub[0]['Rembulitem']['montant'];
		                                /******************************************************/
		                                /******************************************************/
		                               
		                                $salairebrut = $salairebase + $indFonction + $indLogement + $indTransport + $indSujetion + $anciennete + $indGuichet + $indCaisse + $avoir2 +  $avnatrans;
		                            ...
		                            if($code == 400)
		                            {
		                                ...
		                                /******************************************************/
		                                $salairebrute = $salairebase + $indFonction + $indLogement + $indTransport + $indSujetion + $indGuichet + $anciennete + $indCaisse + $avoir2;
		                            ...
		                            if($code == 402)
		                            {
		                                ...
		                                $salairebase = $sal[0]['Paramsalbasegrat']['salaire_base_grat'];
		                                ...
		                                /******************************************************/
		                                $salairebrut = $salairebase + $indFonction + $indLogement + $indTransport + $indSujetion + $anciennete + $indGuichet + $indCaisse +  $avoir2;
	                ...
	                foreach ($contrats as $index => $contrat)
	                {
	                    ...
	                    else
	                    {
		                	...
		                	$agent = array('Rembulletin'=>array(
							    ...
							    'taux_prorata ' => $postData['Rembulletin']['taux_prorata']
	...
	public function edit2() {
		...
		if(isset($postData['Rembulletin']['submit']) && isset($postData['Rembulletin'])){
			   ...
			   $postData['Rembulletin']['paramtypesalaire_id']<>'')
            {
	            ...
	            {
                    /*++++++++++++++++GRATIFICATION OU 13E MOIS+++++++++++++++++++++++++++++++*/
    				$contrats = $this->Agcontrat->find('all', array('conditions'=>array('Agcontrat.agdossier_id='.$postData['Rembulletin']['ag_dossier']), 'recursive'=>0));
	...
	public function index3() {
        ...
        $tmp = $this->Rembulletin->find('all', array('recursive'=>0, 'order'=>'id desc'));
		$datedebut = (isset($tmp[0]['Rembulletin']['date_debut']))?$tmp[0]['Rembulletin']['date_debut']:'2020-01-01';
		$datefin = (isset($tmp[0]['Rembulletin']['date_fin']))?$tmp[0]['Rembulletin']['date_fin']:'2020-01-31'; 
	...
	public function index5() {
        ...
        $tmp = $this->Rembulletin->find('all', array('recursive'=>0, 'order'=>'id desc'));
		$datedebut = (isset($tmp[0]['Rembulletin']['date_debut']))?$tmp[0]['Rembulletin']['date_debut']:'2021-01-01';
		$datefin = (isset($tmp[0]['Rembulletin']['date_fin']))?$tmp[0]['Rembulletin']['date_fin']:'2021-01-31'; 
