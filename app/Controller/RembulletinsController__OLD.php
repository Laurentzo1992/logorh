		                ...
		                if($nbr_bul > 0)
		                {
	                      ...
	                      $cnss_gratif = 0;
			               ...
			               $cnss_normal = $txt[0]['Rembulitem']['montant'];
			                ...
			                if(isset($cnss_normal) && $cnss_normal >= 33000)
			                  {
			                  	$cnss_gratif = 0;
			                  }
			                  else
			                  {
			                  	$cnss_gratif = 33000 - $cnss_normal;
			                  }
	                ...
	                if($cpt > 0)
	                {
		                ...
		                foreach($contrats as $index => $contrat)
		                {
		                   ...
		                   $ag_dossier = $contrat['Rembulletin']['ag_dossier'];
		                    ...
		                    $decembre = $this->Rembulletin->find('all', array('conditions'=>array("Rembulletin.ag_dossier='{$ag_dossier}'","Rembulletin.paramtypesalaire_id='1'","Rembulletin.date_debut ='{$begin}'","Rembulletin.date_fin='{$end}'"), 'recursive'=>0));
		                    $bulletinid = $decembre[0]['Rembulletin']['id'];
				            $nbr_bul = count($decembre);
			                if($nbr_bul > 0)
			                {
			                  ...
			                  $anciennete = $traitement_base * $taux * 0.01;
