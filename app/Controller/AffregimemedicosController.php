...
class AffregimemedicosController extends AppController{	
	...
	var $uses = array('User','Paramregimemedico','Agdossier','Paramsrtucsanitaire','Paramregimemedico','Signataire');
	...
	public function edit() {
		...
		if(isset($postData['Affregimemedico']['submit']) && isset($postData['Affregimemedico'])){
               ...
               $postData['Affregimemedico']['montant']<>'')
            {
		            ...
		            $postData['Affregimemedico']['taux']  = $valeur;
                    $postData['Affregimemedico']['unite']  = $unite;
					/*------------------------------------*/	
