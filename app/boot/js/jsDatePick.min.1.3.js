...
g_l=[];
g_l.MONTHS=["Janvier","Fevier","Mars","Avril","Mai","Juin","Juillet","Aout","Septembre","Octobre","Novembre","Decembre"];
g_l.DAYS_3=["Dim","Lun","Mar","Wed","Jeu","Ven","Sam"];
g_l.MONTH_FWD="Avancer d'un mois";
g_l.MONTH_BCK="Reculer d'un mois";
g_l.YEAR_FWD="Avancer d'une annee";
g_l.YEAR_BCK="Reculer d'une annee";
...
/*
	...
	Thank you!
*/
g_jsDatePickImagePath = "/logistics/app/boot/img/datepickerimg/";
...
JsDatePick.prototype.setConfiguration = function(aConf){
	...
	this.oConfiguration.yearsRange		= (aConf["yearsRange"] != null) ? aConf["yearsRange"] : [1900,2100];
	...
	this.oConfiguration.imgPath			= (g_jsDatePickImagePath.length != null) ? g_jsDatePickImagePath : "/img/cal/";
